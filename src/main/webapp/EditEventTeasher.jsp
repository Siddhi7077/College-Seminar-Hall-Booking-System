...
<%
    ...
    if (eventIdStr == null || eventIdStr.isEmpty()) {
        out.println("<h3>Error: Event ID is missing.</h3>");
        return;
    }
    ...
    PreparedStatement ps = con.prepareStatement("SELECT * FROM event WHERE event_id=? AND t_id=?");
    ps.setInt(1, eventId);
    ps.setInt(2, loggedInTeacherId);
    ResultSet rs = ps.executeQuery();

    if (!rs.next()) {
        out.println("<h3>Error: Event not found or unauthorized access.</h3>");
        con.close();
        return;
    }
...
<body>
 <header>
    ...
    <div class="adminsidebar">
        <a href="#" id="addEventBtn" data-target="addEvent">Add Event</a>
    ...
    <h2>Edit Event</h2>
    <form action="EditEventTeacherServlet" method="post" enctype="multipart/form-data">
        <input type="hidden" name="event_id" value="<%= eventId %>">

        <label>Event Name:</label>
        <input type="text" name="event_name" value="<%= eventName %>" required><br>

        <label>Event Date:</label>
        <input type="date" name="event_date" value="<%= eventDate %>" required><br>

        <label>Start Time:</label>
        <input type="time" name="start_time" value="<%= startTime %>" required><br>

        <label>End Time:</label>
        <input type="time" name="end_time" value="<%= endTime %>" required><br>

        <label>Department:</label>
        <input type="text" name="department" value="<%= department %>" required><br>

        <label>Hosted By:</label>
        <input type="text" name="hosted_by" value="<%= hostedBy %>" required><br>

        <label>Description:</label>
        <textarea name="description" required><%= description %></textarea><br>

        <label>Cost:</label>
        <input type="number" name="cost" value="<%= cost %>" min="0" required><br>
        ...
        <% if ("Completed".equals(status)) { %>
             <label>Upload up to 5 Images with Descriptions:</label>
        <br>
        <input type="file" name="event_image1">
        <input type="text" name="description1" placeholder="Enter description for Image 1">
        <br>
        <input type="file" name="event_image2">
        <input type="text" name="description2" placeholder="Enter description for Image 2">
        <br>
        <input type="file" name="event_image3">
        <input type="text" name="description3" placeholder="Enter description for Image 3">
        <br>
        <input type="file" name="event_image4">
        <input type="text" name="description4" placeholder="Enter description for Image 4">
        <br>
        <input type="file" name="event_image5">
        <input type="text" name="description5" placeholder="Enter description for Image 5">
        <br>
        <% } %>
