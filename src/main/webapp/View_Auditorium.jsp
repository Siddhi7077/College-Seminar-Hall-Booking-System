...
<html>
<head>
    <title>View Auditorium List</title>
    <style>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="Edit_Auditorium.jsp?id=<%= rs.getInt("id") %>">Edit</a>
                </td>
                <td>
                    <a href="javascript:void(0);" onclick="confirmDelete(<%= rs.getInt("id") %>)" style="color:red;">Delete</a>
                </td>
            </tr>
            <%
                    }
