...
<head>
    ...
    document.getElementById("viewAuditoriumsBtn").addEventListener("click", function (event) {
        ...
        function checkForm() {
            ...
            console.log("ID before submitting: " + id);
            if (!id) {
...
<header>
    ...
    <div class="container">
        ...
        <%
            ...
            System.out.println("Editing Auditorium ID: " + id);
            ...
            try {
                ...
                PreparedStatement ps = con.prepareStatement("SELECT * FROM auditorium WHERE id=?");
                ps.setInt(1, id);
                ...
                if (rs.next()) {
                    ...
                    out.println("No auditorium found with this ID.");
                }
                con.close();
            } catch (Exception e) {
                e.printStackTrace();
        ...
        <form action="EditAuditoriumServlet" method="post" enctype="multipart/form-data" onsubmit="return checkForm();">
